import { AnimationClip, AnimationClipJSON } from ".pnpm/@types+three@0.176.0/node_modules/@types/three/src/animation/AnimationClip.js";
import { Camera } from ".pnpm/@types+three@0.176.0/node_modules/@types/three/src/cameras/Camera.js";
import { ShapeJSON } from ".pnpm/@types+three@0.176.0/node_modules/@types/three/src/extras/core/Shape.js";
import { Material, MaterialJSON } from ".pnpm/@types+three@0.176.0/node_modules/@types/three/src/materials/Material.js";
import { Euler } from ".pnpm/@types+three@0.176.0/node_modules/@types/three/src/math/Euler.js";
import { Matrix3 } from ".pnpm/@types+three@0.176.0/node_modules/@types/three/src/math/Matrix3.js";
import { Matrix4, Matrix4Tuple } from ".pnpm/@types+three@0.176.0/node_modules/@types/three/src/math/Matrix4.js";
import { Quaternion } from ".pnpm/@types+three@0.176.0/node_modules/@types/three/src/math/Quaternion.js";
import { Vector3, Vector3Tuple } from ".pnpm/@types+three@0.176.0/node_modules/@types/three/src/math/Vector3.js";
import { Group } from ".pnpm/@types+three@0.176.0/node_modules/@types/three/src/objects/Group.js";
import { SkeletonJSON } from ".pnpm/@types+three@0.176.0/node_modules/@types/three/src/objects/Skeleton.js";
import { WebGLRenderer } from ".pnpm/@types+three@0.176.0/node_modules/@types/three/src/renderers/WebGLRenderer.js";
import { Scene } from ".pnpm/@types+three@0.176.0/node_modules/@types/three/src/scenes/Scene.js";
import { SourceJSON } from ".pnpm/@types+three@0.176.0/node_modules/@types/three/src/textures/Source.js";
import { TextureJSON } from ".pnpm/@types+three@0.176.0/node_modules/@types/three/src/textures/Texture.js";
import { BufferGeometry, BufferGeometryJSON } from ".pnpm/@types+three@0.176.0/node_modules/@types/three/src/core/BufferGeometry.js";
import { EventDispatcher } from ".pnpm/@types+three@0.176.0/node_modules/@types/three/src/core/EventDispatcher.js";
import { Layers } from ".pnpm/@types+three@0.176.0/node_modules/@types/three/src/core/Layers.js";
import { Intersection, Raycaster } from ".pnpm/@types+three@0.176.0/node_modules/@types/three/src/core/Raycaster.js";
