import type { ConstructorOverloadParameters, NumOverloads, OverloadsInfoUnion } from '.pnpm/expect-type@1.3.0/node_modules/expect-type/dist/overloads';
import type { IsNever, IsAny, IsUnknown, ReadonlyKeys, RequiredKeys, OptionalKeys, MutuallyExtends, UnionToTuple } from '.pnpm/expect-type@1.3.0/node_modules/expect-type/dist/utils';
/**
