...
import { BaseAxisProps, TickItem, PresentationAttributesAdaptChildEvent } from '.pnpm/recharts@2.15.4_react-dom@18.3.1_react@18.3.1__react@18.3.1/node_modules/recharts/types/util/types';
...
export declare class PolarRadiusAxis extends PureComponent<Props> {
     ...
     * @return {Object} (x, y)
     */
    getTickValueCoord({ coordinate }: TickItem): import(".pnpm/recharts@2.15.4_react-dom@18.3.1_react@18.3.1__react@18.3.1/node_modules/recharts/types/util/types").Coordinate;
